...
#..............................................................................
location_input_file= r'R:\03_GISdata\data_Gabriel\04-Tools\02-Python-Scripts\02-Input-files-R\Inputs-MIP-Optimisation'
...
model.objective = minimize(xsum((cost[i][j]*F[i][j]*20*365*24*Ecost/1000000+capitalcost[i][j]*y[i][j]*Ccost) for i in tqdm(V) for j in tqdm(V)))
